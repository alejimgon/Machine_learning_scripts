...
# KNN is a non-linear and non-parametric algorithm. It is a lazy learning algorithm because it doesn't learn a discriminative function from the training data but memorizes the training dataset instead.
